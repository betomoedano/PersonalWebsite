    ...
    <div className="w-full h-auto md:relative py-20">
        <div className="px-4 md:p-0 max-w-5xl mx-auto flex flex-col-reverse md:flex-row"> 
            ...
            <div className="md:w-1/2 mb-10">
                ...
                <p className="text-base md:text-md leading-loose md:font-normal text-gray-700 dark:text-gray-50">Souls X was born with the idea of creating a simple and fun drag and drop game. It has features like; 16 creative levels, skins shop, haptics, particle effects.</p>
            </div>
        </div>
        <div className="max-w-5xl mx-auto px-4">
            ...
            <p className="mb-10 text-2xl md:text-3xl font-semibold text-gray-500 dark:text-gray-300 ">I'm constantly improving my projects and working on new ideas, loving what I do.</p>
        </div>
    </div>
    )
}
