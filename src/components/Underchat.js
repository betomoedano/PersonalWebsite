    ...
    <div className="w-full h-auto md:relative py-20 px-4">
        <div className="md:p-0 max-w-5xl mx-auto flex flex-col md:flex-row">
            <div className="md:w-1/2 flex flex-col items-center justify-center">
                ...
                <p className="mb-8 w-full text-3xl font-medium text-gray-700 dark:text-gray-50">Simple, clean, and real-time chat app</p>
                <p className="text-base text-left md:text-md leading-loose md:font-normal text-gray-700 dark:text-gray-50">
                UnderChat is a multi-user chat application that allows users to add friends by quickly searching their username, can add profile pictures, 
